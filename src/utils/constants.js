...
export const CART = 'cartAq'
export const ARTICULOS = 'saArticuloAq'
export const PRECIOS = 'saArtPrecioAq'
export const UNIDAD = 'saArtUnidadAq'
export const STOCK = 'saArtStockAq'
export const CLIENT = 'clientAq'
export const CLIENTES = 'saClienteAq'
export const SUCURSAL = '01'
export const ALMACEN = 'CEDIS'
export const MONEDA = '$'
export const DB = 'aquila_a'
export const TASA = 'tasaAq'
export const PEDIDOS = 'saPedidosVentaAq'
export const TRANSPORTE = 'saTransporteAq'
export const FORMA_PAGO = 'saFormaPagoAq'
...
export const EMAIL = 'karla.torres@michachá.com'
